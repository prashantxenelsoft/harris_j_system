        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="tab-content" id="myTabContent">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="icon-group-listing">
                                                            <span>
                                                                <i class="fa-solid fa-angle-down accordion-toggle"
                                                            ...
                                                            <div class="bom-list-row-expand">
                                                                ...
                                                                <div class="list-row-below-card">
                                                                    <ul>
                                                                        ...
                                                                        <li>
                                                                            <p>License Start Date: <b> 12 / 07 /
                                                                                    2025</b></p>
                                                                        </li>

                                                                        <li>
                                                                            <p>Fees Structure: <img
                                                                                    src="{{ asset('public/assets/latest/images/Admin- indication.png ') }}"
                                                                                    class="img-fluid"></p>
                                                                        </li>

                                                                        <li>
                                                                            <p>Last Paid Status: <span
                                                                                    class="unpaid-badge"><i
                                                                                        class="fa-solid fa-circle-xmark"></i>Unpaid</span>
                                                                            </p>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                    ...
                    <div class="tab-pane fade" id="finances" role="tabpanel" aria-labelledby="contact-tab">
                                ...
                                <div class="col-md-12">
                                    <table class="table table-condensed table-striped">
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="icon-group-listing">
                                                            <span>
                                                                <i class="fa-solid fa-angle-down accordion-toggle"
                                                                    data-bs-toggle="collapse" data-bs-target="#demo1332"
                                                                    class="">
                                                                </i>
                                                            </span>
                                                ...
                                                <tr>
                                                    <td colspan="12" class="hiddenRow">
                                                        <div class="accordion-body collapse" id="demo1332">
                                                            <div class="bom-list-row-expand">
                                    ...
                                    <div class="row add-consultancy-form">
                                        <div class="col-lg-12">
                                            <form id="consultancyForm" method="POST" action="#" enctype="multipart/form-data">
                                                ...
                                                <div class="form-row-consultancy">
                                                    <div class="consultancy-form-col">
                                                        <input type="text" name="serving_client" placeholder="Serving Client *" required />
                                                    </div>
                                                    <input type="hidden" name="edit_id" value="" />

                                                    <div class="consultancy-form-col">
                                                        <input type="text" name="client_id" placeholder="Calient ID *" required />
                                                    </div>

                                                   

                                                    <div class="consultancy-form-col add-address-col" data-bs-toggle="modal" data-bs-target="#staticBackdrop1">
                                                        <i class="fa-solid fa-house"></i>
                                                        <p>Add Address</p>
                                                    </div>
                                                    ...
                                                    <div class="consultancy-form-col">
                                                        <select name="client_status" required>
                                                            ...
                                                            <option value="Disabled">Nepal</option>
                                                            <option value="Block">Pakistan</option>
                                                            <option value="Deleted">Sri Lanka</option>
                                                        </select>
                                                    </div>
                                                    <!-- Image Preview Modal -->
                                                    <div
