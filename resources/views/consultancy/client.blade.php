                    ...
                    <tr>
                        ...
                        <td>
                            <div class="icon-group-listing">
                                <span>
                                    <i class="fa-solid fa-angle-down accordion-toggle" data-bs-toggle="collapse" data-bs-target="#demo1332" class=""> </i>
                                </span>
...
<script>
    ...
    function populateCountries(selectId) {
        ...
        for (const country in countryIsoMap) {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        populateCountries('client_country');
