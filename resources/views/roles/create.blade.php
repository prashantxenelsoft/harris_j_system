...
<div class="pc-container">
    <div class="pc-content">
        <div class="container mt-4">
            <h4 class="mb-3">Add Role</h4> <!-- Smaller Heading -->
            ...
            <form action="{{ route('roles.store') }}" method="POST">
                ...
                <h6 class="mt-4 mb-2">Menus Permissions</h6> <!-- Smaller Sub Heading -->
                        ...
                        @foreach($menus as $key => $menu)
                            <tr>
                                ...
                                <td class="text-center">
                                    <input type="checkbox" class="form-check-input view-checkbox" name="permissions[{{ $menu->id }}][view]" value="1">
                                </td>
                                <td class="text-center">
                                    <input type="checkbox" class="form-check-input edit-checkbox" name="permissions[{{ $menu->id }}][edit]" value="1">
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
