    ...
    <div class="row static-tab-screen-inner">
      <div class="col-lg-3">
        ...
        <div class="vertical-tabs-switches">
          <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            <button class="nav-link" id="v-pills-consultancy-tab" data-bs-toggle="pill" data-bs-target="#v-pills-consultancy" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">
      ...
      <div class="col-lg-9">
        <div class="tab-content" id="v-pills-tabContent">
          ...
          <div class="tab-pane fade" id="v-pills-consultancy" role="tabpanel" aria-labelledby="v-pills-consultancy-tab">...</div>
