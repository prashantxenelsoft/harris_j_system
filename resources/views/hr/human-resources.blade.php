                           ...
                           <div class="calendar-ui">
                              <div class="hr-tab-inner-top-profile-row">
                                 <div class="profile-header">
                                    <img src="{{ asset('public/assets/images/profile-icon-img.png')}}" alt="Profile Picture" class="profile-pic" data-bs-toggle="modal" data-bs-target="#hr-profile-modal" /> 
                                    <div>
                                       <h3>Bruce Lee</h3>
                                 ...
                                 <div class="modal fade" id="hr-profile-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                           ...
                           <div class="row mt-4 bottom-remark-timesheet-group">
                              <div class="col-lg-6 col-xl-4 mb-4 mb-xl-none position-relative">
                                 <div class="work-summary write-summary">
                                    <button class="expand-btn" data-bs-toggle="modal" data-bs-target="#workSummaryModal"> <img src="{{ asset('public/assets/images/expand-icon.png')}}"> </button> 
                              ...
                              <div class="col-lg-6 col-xl-4 mb-4 mb-xl-none">
                                 <div class="remark-section card p-3">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                       <h6>Remarks</h6>
                                       <div class="btn-group-remark"> <button class="btn btn-link p-0 text-danger" data-bs-toggle="modal" data-bs-target="#remarksModal"> <img src="{{ asset('public/assets/images/expand-icon.png')}}"> </button> <button class="flow-edit-btn" data-bs-toggle="modal" data-bs-target="#editRemarksModal"> <i class="fa-solid fa-pen-nib"></i> </button> </div>
                                    </div>
                              ...
                              <div class="col-lg-6 col-xl-4">
                                 <div class="timesheet-section card p-2">
                                    <div class="timesheet-header d-flex justify-content-between align-items-start">
                                       ...
                                       <button class="expand-btn" data-bs-toggle="modal" data-bs-target="#timesheetModal"> <img src="{{ asset('public/assets/images/expand-icon.png')}}"> </button> 
                                    </div>
                                       ...
                                       <div class="tab-pane fade show active" id="overviewTab">
                                          <div class="timeline">
                                             <div class="timeline-item d-flex align-items-start mb-3">
                                                ...
                                                <div>
                                                   <div class="d-flex align-items-center mb-1 tl-header"> <img src="https://i.pravatar.cc/24" class="rounded-circle me-2"> <span class=" text-primary">PH - (1)</span> </div>
                                                   <div class="tl_details"> <span>Sat, 15 Aug - </span> <span class="badge ">PH</span> <span>-</span> <span class="text-primary badge badge bold_text"> Paid day off</span> <span> - 3 hours off</span> </div>
                                                </div>
                                             </div>
                                             <div class="timeline-item d-flex align-items-start mb-3">
                                                <div class="me-2">
                                             ...
                                             <div class="timeline-item d-flex align-items-start mb-3">
                                                ...
                                                <div>
                                                   <div class="d-flex align-items-center mb-1 tl-header"> <img src="https://i.pravatar.cc/24" class="rounded-circle me-2"> <span class=" text-primary">PH - (1)</span> </div>
                                                   <div class="tl_details"> <span>Sat, 15 Aug - </span> <span class="badge ">PH</span> <span>-</span> <span class="text-primary badge bold_text"> Paid day off</span> <span> - 3 hours off</span> </div>
                                                </div>
                                             </div>
                                             <div class="timeline-item d-flex align-items-start mb-3">
                                                <div class="me-2">
                                       ...
                                       <div class="tab-pane fade" id="extraTimeTab">
                                          <div class="timeline">
                                             <div class="timeline-item d-flex align-items-start mb-3">
                                                ...
                                                <div>
                                                   <div class="d-flex align-items-center mb-1 tl-header"> <img src="https://i.pravatar.cc/24" class="rounded-circle me-2"> <span>Comp - Off</span> </div>
                                                   <div class="tl_details"> <span>15/08/2024 -</span> <span class="badge">Comp - Off <sub>HD1</sub></span> <span>- 4 : 00 hours</span> </div>
                                                </div>
                                             </div>
                                          </div>
                                          <div class="timeline">
                                             ...
                                             <div class="timeline-item d-flex align-items-start mb-3">
                                                ...
                                                <div>
                                                   <div class="d-flex align-items-center mb-1 tl-header">
                                                      ...
                                                      <div class="pay_off_log"> <span>03/08/2024 - </span> <span>4 : 00 hours</span> </div>
                                                   </div>
                                                </div>
                                             </div>
                                             <div class="timeline-item d-flex align-items-start mb-3">
                                          ...
                                          <div class="timeline">
                                             <div class="timeline-item d-flex align-items-start mb-3">
                                                ...
                                                <div>
                                                   <div class="d-flex align-items-center mb-1 tl-header">
                                                      <img src="https://i.pravatar.cc/24" class="rounded-circle me-2"> 
                                                      <div class="comp_off_log"> <span>03/08/2024 -</span> <span class="badge">Comp - Off <sub>HD1</sub></span> <span>- 4 : 00 hours</span> </div>
                                                   </div>
                                                </div>
                                             </div>
                                             <div class="timeline-item d-flex align-items-start mb-3">
                                          ...
                                          <div class="modal-body">
                                             <div class="timesheet-header d-flex justify-content-between align-items-center">
                                                <ul class="nav nav-tabs popup_tabs" id="timesheetTabs">
                                                   <li class="nav-item"> <button class="nav-link tab_btn active" data-bs-toggle="tab" data-bs-target="#modeloverviewTab">Timesheet Overview</button> </li>
                                                   <li class="nav-item"> <button class="nav-link tab_btn" data-bs-toggle="tab" data-bs-target="#modelextraTimeTab">Extra Time Log</button> </li>
                                                   <li class="nav-item"> <button class="nav-link tab_btn" data-bs-toggle="tab" data-bs-target="#modelpayOffTab">Pay-Off Log</button> </li>
                                                   <li class="nav-item"> <button class="nav-link tab_btn" data-bs-toggle="tab" data-bs-target="#modelcompOffTab">Comp-off log</button> </li>
                                                   <li class="nav-item"> <button class="nav-link tab_btn" data-bs-toggle="tab" data-bs-target="#modelcopiesTab">Get Copies</button> </li>
                                                </ul>
                                             </div>
