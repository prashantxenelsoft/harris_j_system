  ...
  <div style="max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1); border: 1px solid #e0e0e0;">
    ...
    <div style="padding: 30px;">
      ...
      <p style="font-size: 15px; line-height: 1.6;">
        We would like to inform you that your <strong>claim submission</strong> has been updated and is now marked as:
      ...
      <p style="font-size: 15px; line-height: 1.6; margin-top: 20px;">
        Please log in to your account to review the updated claim status and take any necessary action.
      </p>
    </div>
