            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="login-right-col">
                        <h2>“ Track Your Impact , Make Progress,
                            Transform Lives “</h2>
                        <form id="loginForm" method="POST" action="{{ route('admin.login.submit') }}">
                            ...
                            <div class="login-form-plicy">
                                <p>We truly protect your personal information registered in the system in accordance
                                    to <a href="#">privacy laws</a> laws and <a href="#"> our policy</a></p>
                            </div>
